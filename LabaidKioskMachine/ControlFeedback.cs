...
namespace LabaidKioskMachine
{
    public partial class ControlFeedback : UserControl
    {
        ...
        public ControlFeedback( string s1, int s2, string s3, string s4, string s5)
        {
            InitializeComponent();
            uName = s1;
            uAge = s2;
        ...
        public ControlFeedback(int[,] tv,string s1, int s2, string s3, string s4, string s5)
        {
            InitializeComponent();
            uName = s1;
            uAge = s2;
        ...
        private void bunifuiOSSwitch1_OnValueChange(object sender, EventArgs e)
        {
            if (!bunifuiOSSwitch1.Value)
            {
                ...
                this.Controls.Clear();
                ControlFeedbackBn cc = new ControlFeedbackBn(arrayRating,uName, uAge,uRelation,uContact,uEmail);
                this.Controls.Add(cc);
                cc.Show();
                cc.Dock = DockStyle.Fill;
